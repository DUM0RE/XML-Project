...
if (xml.parseError.errorCode != 0)
 { WScript.Echo (xmlIn+" Parse Error: "+xml.parseError.reason + " line: " + xml.parseError.line);}

xsl.async = false; // Load XSL style sheet
xsl.load(xslIn);

if (xsl.parseError.errorCode != 0)
 { WScript.Echo (xslIn+" Parse Error: "+xsl.parseError.reason + " line: " + xsl.parseError.line);}
